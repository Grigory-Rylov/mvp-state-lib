 ...
 */
public abstract class MvpRelativeLayout<P extends BaseMvpPresenter, VS extends Serializable>
        extends RelativeLayout implements StateObserver<VS>, DelegateTagHolder<VS> {
